...
<div class="page-group">
    <div class="page page-current page-login">
        ...
        <!--<p class="login-box-msg">使用账户密码登录</p>-->
        <!--<form>-->
        <!--<input type="text" class="form-control" placeholder="用户名/手机号">-->
        <!--<input type="password" class="form-paw" placeholder="密码">-->
        <!--</form>-->
        <!--</div>-->
        <!--</div>-->
        <div class="content">
            <div class="login-10">
                <div class="tenth-login">
                    ...
                    <form class="ten">
                        ...
                        <li class="cream">
                            <input type="password" value="Password" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'Password';}"><a href="#" class=" icon10 lock10"></a>
                        </li>
                        <div class="submit-ten">
                            <input type="submit" onClick="myFunction()" value="Log in" >
                        </div>
                    </form>
                    <p class="tail-paw">Forget the password?<a class="log-tail">Retrieve the password</a></p>
                    <p class="tail-paw">Is there no account number?<a class="log-tail">Go to registration</a></p>
                </div>
            </div>
        </div>
    </div>
